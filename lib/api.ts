...
export const api = {
  ...
  users: {
    ...
    create: (data: Partial<IUser>) =>
      fetchHandler(`${API_BASE_URL}/users/`, { method: "POST", body: JSON.stringify(data) }),
    update: (id: string, data: Partial<IUser>) =>
      fetchHandler(`${API_BASE_URL}/users/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  accounts: {
    ...
    update: (id: string, data: Partial<IAccount>) =>
      fetchHandler(`${API_BASE_URL}/accounts/${id}`, { method: "PUT", body: JSON.stringify(data) }),
